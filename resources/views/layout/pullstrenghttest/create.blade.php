                ...
                <div class="white-box">
                    ...
                    <form action="{{ route('pullstrengthtest.store') }}" class="form" method="POST">
                            ...
                            <div class="col-sm-12">
                                <select class="custom-select col-10" id="inlineFormCustomSelect" name="station">
                                    ...
                                    @foreach($station as $process)
                                        <option value="{{ $process }}" {{ old('station') == $process ? 'selected' : '' }}>{{ $process }}</option>
                                @endforeach
                                </select>
                            @error('station')
                                <div class="text-danger">{{ $message }}</div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-10">
                                <input class="form-control @error('time') is-invalid @enderror" name="start_time" type="time" value="{{ old('start_time') }}" id="example-time-input">
                            @error('time')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-10">
                                <input class="form-control @error('time') is-invalid @enderror" name="end_time" type="time" value="{{ old('end_time') }}" id="example-time-input">
                            @error('time')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-10">
                                <textarea class="form-control" name="deskcription" rows="5"></textarea>
                            </div>
                        </div>
