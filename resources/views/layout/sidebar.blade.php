...
<div class="navbar-default sidebar" role="navigation">
    ...
    <button class="btn btn-default" type="button"> <i class="fa fa-search"></i> </button>
            ...
            <li> <a href="index.html" class="waves-effect"><i class="zmdi zmdi-copy zmdi-hc-fw fa-fw" ></i> <span class="hide-menu"> PRODUCTION <span class="fa arrow"></span> </span></a>
                <ul class="nav nav-second-level">
            ...
            <li> <a href="index.html" class="waves-effect"><i class="zmdi zmdi-apps zmdi-hc-fw fa-fw" ></i> <span class="hide-menu"> Facility <span class="fa arrow"></span> </span></a>
                <ul class="nav nav-second-level">
            ...
            <li> <a href="index.html" class="waves-effect"><i class="zmdi zmdi-chart zmdi-hc-fw fa-fw" ></i> <span class="hide-menu"> NTD <span class="fa arrow"></span> </span></a>
                <ul class="nav nav-second-level">
