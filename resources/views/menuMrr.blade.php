                                ...
                                <tbody>
                                    @foreach ($MRR as $Mrr)
                                        <tr>
                                            ...
                                            <td>{{ $Mrr->noMrr }}</td>
                                            <td>{{ $Mrr->RequestDept }}</td>
                                            <td>{{ $Mrr->Process }}</td>
                                            <td>{{ $Mrr->Name }}</td>
                                            <td>{{ $Mrr->Description }}</td>
                                            <td>{{ $Mrr->Shift }}</td>
                                            <td>{{ $Mrr->Date }}</td>
                                            <td>{{ $Mrr->BreakDownTime }}</td>
                                            <td>{{ $Mrr->ReportTime }}</td>
                                            <td>{{ $Mrr->SignSpvProd }}</td>
                                            <td>
                                                <a href="{{ route('mrr.edit', $Mrr->id) }}" class='fcbtn btn btn-primary btn-outline btn-1b waves-effect'> <i class="fas fa-pen"> Edit </a>
